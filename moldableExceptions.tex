...
\begin{figure}[t]
  ...
  \caption{A moldable inspector view of a ZnUrl object and its source code. \tg{We should use here an example we can reuse in the description of the debugger. I propose to use the Moves view of the Ludo game and replace \autoref{fig:ludoCustomViewsSource}}}
...
Let us go through a typical example.
...
\steve{line 323 I find the transition between examples a bit rough, perhaps paragraphs with identified titles could help}
\begin{figure}[h]
