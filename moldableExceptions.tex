...
%
\documentclass[sigplan,screen]{acmart} % CAMERA-READY
%
%\documentclass[sigplan,anonymous,review,10pt]{acmart} % REVIEW version
%
...
%
% ============================================================
% uses the microtype package using \usepackage{microtype} for improved typesetting
...
\AtBeginDocument{%
  \providecommand\BibTeX{{%
    Bib\TeX}}}
% ============================================================
%%% The following is specific to Onward! '24-PAPERS and the paper
%%% 'Moldable Exceptions'
%%% by Andrei Chiş, Tudor Gîrba, and Oscar Nierstrasz.
%%%
\ifthenelse{\boolean{preprint}}{% FOR PREPRINT
\setcopyright{acmlicensed}
}{% FOR CAMERA-READY
\setcopyright{ACMUNKNOWN} % Required by author instructions; ignore error and proceed.
}
\acmDOI{10.1145/3689492.3690044}
\acmYear{2024}
\copyrightyear{2024}
...
\acmSubmissionID{onward24papers-p5-p}
\received{2024-04-25}
...
\begin{document}
\ifthenelse{\boolean{preprint}}{% FOR PREPRINT
\title[Moldable Exceptions --- preprint]{Moldable Exceptions}\thanks{Preprint of paper presented at Onward!, Pasadena, CA, Oct.\ 20-25, 2024.}
}{% FOR CAMERA-READY
...
%NB: ``If the paper is accepted, the final submission will be limited to 17 pages. (The 13-page limit for the main body of the paper no longer applies.)''}
...
These methods are annotated with a \lst{<gtExceptionView>} pragma for views and a \lst{<gtExceptionAction>} pragma for actions to extend the moldable debugger
...
Specifically, the moldable debugger game view for a \lmaf simply reuses the moldable inspector view called \st{gtPositionsFor:} that is already defined in the \st{game} object.
\begin{code}
gtGameViewFor: aView
	<gtExceptionView>
	^ aView forward
...
%\on{Added a sentence to emphasize the point}
...
% Babylonian programming -- Broadening the View of Live Programmers
...
%\footnote{\url{https://github.com/hpi-swa-lab/babylonian-programming-smalltalk}}
...
%\meh{Debuggers are unloved beasts.
%They provide a generic and low-level interface to explore and debug the run-time state of a running program.
%Many debugging problems can be better tackled by understanding the nature of the exception that was raised and caused the debugger to be activated.}
%\on{Moved this to the intro -- need to paraphrase this}
