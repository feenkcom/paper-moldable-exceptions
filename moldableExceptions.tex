...
To achieve this we rely on the fact that tests raise \lst{ComparisonFailures} exceptions when two documents do not match.
...
\begin{code}
TextOrVisualComparisonType>>gtDebugActionAcceptFor: anAction 
		inContext: aPhlowActionContext
	<lwComparisonAction>
