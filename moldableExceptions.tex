...
Moldable exceptions build on and extend the notions of custom views and actions that can be used to extend a moldable object inspector~\cite{Chis15a}.
...
Instead of just showing us the classical ``raw'' view of the objects instance variables, we see here one of several dedicated views providing detailed information about the URL.
Just below we see part of the (Smalltalk) source code defining this view
...
At the time of writing we have implement some 26 custom debugger views, with an average of under 12 lines of code.
...
\cite{Chis15a}
Early version of Inspector did not have such an easy mechanism to add views.
