...
We just need to define three view methods in the class \lmaf.
...
We similarly define methods for the history of past moves, and a graphical view of the current move, and now the debugger, instead of showing us the classical debugger, will offer us these three views.
The Game view shows us the current game state graphically, the Moves view shows us a browsable list of pas moves, and the Move view graphically depicts what happened during the last move.
...
\begin{figure}[h]
  ...
  \includegraphics[width=\columnwidth]{ludoView3-Move}
