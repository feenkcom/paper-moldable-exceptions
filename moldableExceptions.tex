...
In Pharo Smalltalk this is achieved with the \lst{\#de\-pre\-cat\-ed:trans\-form\-With:} message defined in the class \st{Object}.
...
\on{AC: Discuss the LifeWare tests?}
...
\on{AC: Can you provide more references and especially more recent ones?}
