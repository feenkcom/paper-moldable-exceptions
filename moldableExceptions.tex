...
Custom views must be built from scratch and integrate in your environment.
...
Bousse \etal have developed a generic omniscient debugger that can be adapted to different DSLs with moderate effort~\cite{Bous18a}.
