...
\begin{figure}[h]
  ...
  \caption{A classical raw view of a Ludo game next to a graphical \emph{Board} view. \tg{I would change this picture with two separate windows showing the two views: this is because people typically associated adjacent panes with some connection - it seems harder for people to grasp that we can spawn the same object there, too. Also, there should be no highlighting in the Raw view.}}
...
\begin{figure}[h]
  ...
  \caption{Scripter textual diff view. \tg{I think here we could show the default debugger with the custom Textual Diff view on the right as an example of how we can extend the default debugger as well.}}
